...
@Entity(tableName = "MealManagementTable")
data class MealManagement(
    var title : String = "식사관리",
    var description : String = "동물체의 주요한 구성성분은 수분, 단백질, 지방, 광물질 그리고 극히 소량의 탄수화물이며, 각각의 구성비율은 동물품종, 연령, 성별 및 동물의 상태에 따라 다르다.\n" +
...
@Entity(tableName = "DangerFoodTable")
data class DangerFood(
    var food : String = "defaultFood",
